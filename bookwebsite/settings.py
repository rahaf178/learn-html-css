...
SECRET_KEY = 'django-insecure-pa!suw$_ggx25p(^3xm+vttx9ewwhyl^amn#f398mn^lei57ft'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "usermodule/static"),
    os.path.join(BASE_DIR, "bookmodule/static"),
]